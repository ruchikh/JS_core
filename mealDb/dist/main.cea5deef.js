...
function mainPage() {
  ...
  fetch(url).then(function (d) {
    ...
    data.categories.forEach(function (v, i) {
      var cat = v.strCategory;
      var des = v.strCategoryDescription;
      var thumb = v.strCategoryThumb;
      var headDiv = document.createElement('div');
      heroImag.appendChild(headDiv);
      var img = document.createElement('img');
      img.setAttribute('src', "".concat(thumb));
      headDiv.appendChild(img);
      var para = document.createElement('h1');
      para.textContent = "".concat(cat);
...
form.addEventListener("submit", function (e) {
  ...
  console.log(query);
  var caturl = "https://www.themealdb.com/api/json/v1/1/search.php?s=".concat(query);
  fetch(caturl).then(function (res) {
    return res.json();
  }).then(function (data) {
    console.log(data);
    data.meals.forEach(function (v, i) {
      var strcat = v.strMeal;
      var insta = v.strInstructions;
      var strthumb = v.strMealThumb;
      var instruction = v.strInstructions;
      var strvideo = v.strYoutube; // favDiv.style.display = "block";
      ...
      catImg.setAttribute('src', "".concat(strthumb));
      catDiv.appendChild(catImg);
      var heading = document.createElement('h1');
      heading.innerText = "".concat(strcat);
      catDiv.prepend(heading);
      var ingredient = document.createElement('p');
      ingredient.innerText = "".concat(instruction);
      catDiv.appendChild(ingredient); // var video = document.createElement('a');
...
function addFav(e) {
  ...
  favDiv.innerHTML = "<i class=\"fas fa-cart-plus\"></i>".concat(counter);
  console.log(favBtn);
...
function displayFav() {
  ...
  favorites.forEach(function (v, i) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39581" + '/');
