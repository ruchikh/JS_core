...
var cat;
var catdata = fetch('https://api.thecatapi.com/v1/images/search', {
  method: "GET",
  header: {
    "Content-Type": "application/json"
  },
  'x-api-key': "932f4cf6-1059-4b3e-b841-48fc4c55fd36"
}).then(function (d) {
  return d.json();
}).then(function (data1) {
  return cat = data1;
...
function displayCat() {
  console.log('MyCaaattt'); // imgCat.setAttribute('src', "https://26.media.tumblr.com/tumblr_lxwc47ZdnA1qzo2pmo1_500.jpg")
...
function displayImage() {
  ...
  fetch(url).then(function (c) {
    ...
    resp.forEach(function (v, i) {
      ...
      imgCat.setAttribute('src', "".concat(v.url));
      catDiv.appendChild(imgCat);
    });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41271" + '/');
